    ...
    <section id="target" className="section-padding bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="font-bold text-mealmate-black mb-4">
            Target di riferimento
          </h2>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            MealMate è pensato per diverse categorie di persone che condividono
            l'interesse per il cibo, la sostenibilità e l'organizzazione.
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="animate-fade-in">
            <h3 className="font-bold text-mealmate-black mb-6">
              Fascia di età dei nostri utenti
            </h3>
                ...
                <div className="flex-1">
                  <div className="relative pt-1">
                    ...
                    <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-mealmate-light-green">
                      <div
                        style={{ width: "25%" }}
                        className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-mealmate-green"
                      ></div>
                    </div>
                ...
                <div className="flex-1">
                  <div className="relative h-52 w-52 mx-auto">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center flex-col">
                      <span className="text-4xl font-bold text-mealmate-black">
                        65%
                      </span>
          ...
          <div className="grid gap-6">
            <h3 className="font-bold text-mealmate-black mb-2">
              Clientela target
            </h3>
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="relative h-52 w-52">
                  ...
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                    <div className="text-4xl font-bold text-mealmate-black">
                      60%
                    </div>
                ...
                <div className="flex-1">
                  <p className="text-gray-700 mb-4">
                    Il 60% degli utenti intervistati si è dichiarato propenso a
                    scaricare la nostra applicazione, dimostrando un forte
                    interesse per una soluzione che aiuti nella gestione dei
                    pasti e nella riduzione degli sprechi alimentari.
                  </p>
          ...
          <div className="animate-fade-in" style={{ animationDelay: "500ms" }}>
            ...
            <div className="bg-mealmate-card-bg rounded-lg p-6 shadow-lg">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <img
                  src="/mealmate-it/lovable-uploads/ae7023f2-d3c8-47c1-b774-f5a9c7862389.png"
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                    ...
                    <span className="text-gray-700">
                      Food Sustainability Seekers - 35%
                    </span>
                  </li>
                  <li className="flex items-center">
                    <span className="w-3 h-3 rounded-full bg-mealmate-green mr-2"></span>
                    <span className="text-gray-700">
                      Healthy Lifestyle Followers - 25%
                    </span>
                  </li>
                  <li className="flex items-center">
                    <span className="w-3 h-3 rounded-full bg-mealmate-green mr-2"></span>
                    <span className="text-gray-700">
                      Cooking Enthusiasts - 30%
                    </span>
                  </li>
                  <li className="flex items-center">
...
const TargetGroupCard = ({
  ...
  return (
    <Card
      className="bg-white shadow-md hover:shadow-lg transition-all duration-300 animate-fade-in"
    ...
    >
      <CardContent className="p-6">
        <div className="flex gap-4 items-start">
          ...
          <div>
            <h4 className="text-lg font-semibold text-mealmate-black mb-2">
              {title}
            </h4>
