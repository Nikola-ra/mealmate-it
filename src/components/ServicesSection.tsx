...
const ServicesSection = () => {
  return (
    <section id="services" className="section-padding bg-mealmate-light-green">
...
const ServiceCard = ({ icon, title, description, delay }: ServiceCardProps) => {
  return (
    <Card className="bg-white shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in" style={{ animationDelay: `${delay}ms` }}>
      <CardHeader>
        <div className="mb-4">
          {icon}
        </div>
